...
public class HttpXmlUtils {
	...
	public static String xmlInfo(WXPayResult xXPayResult){
		//构造xml参数的时候，至少又是个必传参数
		/*
		 * <xml>
			   <appid>wx2421b1c4370ec43b</appid>
		...
		if(xXPayResult!=null){
			...
			bf.append(xXPayResult.getReturn_code());
			bf.append("]]></return_code>");

			bf.append("<result_code><![CDATA[");
			bf.append(xXPayResult.getResult_code());
			bf.append("]]></result_code>");

			bf.append("<out_trade_no><![CDATA[");
			bf.append(xXPayResult.getOut_trade_no());
			bf.append("]]></out_trade_no>");
			bf.append("</xml>");
			return bf.toString();
		}
