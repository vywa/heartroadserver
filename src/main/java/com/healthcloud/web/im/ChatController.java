...
import com.healthcloud.domain.im.Article;
import com.healthcloud.domain.im.NewsMessage;
import com.healthcloud.domain.im.TextMessage;
import com.healthcloud.util.encrypt.SHA1;
	   ...
	   @RequestMapping(value = "menu", method = { RequestMethod.GET, RequestMethod.POST })  
	    ...
	    public void menu(Model model, HttpServletRequest request, HttpServletResponse response) throws IOException {  
		   ...
		   try {
			...
			SingleButton single1 = new SingleButton();
			ClickButton single2 = new ClickButton();
			SingleButton single3 = new SingleButton();
			single1.setName("灵性修炼");
			List<ViewButton> sub_button1 = new ArrayList<ViewButton>();
			ViewButton el11 = new ViewButton();
			el11.setName("青涩年代");			
			el11.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el12 = new ViewButton();
			el12.setName("失恋迷雾");		//如何排遣失恋困扰
			el12.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el13 = new ViewButton();
			el13.setName("激情岁月");		//各种正能量
			el13.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el14 = new ViewButton();
			el14.setName("闻道心路");		//人生感悟
			el14.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el15 = new ViewButton();
			el15.setName("夕阳静美");		//晚岁如何处之
			el15.setUrl("http://123.56.200.202/download/sport.png");
			sub_button1.add(el11);
			sub_button1.add(el12);
			sub_button1.add(el13);
			sub_button1.add(el14);
			sub_button1.add(el15);
			
			single2.setName("诗情画意");
			List<ViewButton> sub_button2 = new ArrayList<ViewButton>();
			ViewButton el21 = new ViewButton();
			el21.setName("天籁之音");
			el21.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el22 = new ViewButton();
			el22.setName("情浓诗醇");
			el22.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el23 = new ViewButton();
			el23.setName("唯美故事");
			el23.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el24 = new ViewButton();
			el24.setName("创意生活");
			el24.setUrl("http://123.56.200.202/download/sport.png");
			sub_button2.add(el21);
			sub_button2.add(el22);
			sub_button2.add(el23);
			sub_button2.add(el24);
			
			single3.setName("奇门八卦");
			List<ViewButton> sub_button3 = new ArrayList<ViewButton>();
			ViewButton el31 = new ViewButton();
			el31.setName("运势管窥");
			el31.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el32 = new ViewButton();
			el32.setName("幽默诙谐");
			el32.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el33 = new ViewButton();
			el33.setName("奇闻轶事");
			el33.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el34 = new ViewButton();
			el34.setName("功力试水");
			el34.setUrl("http://123.56.200.202/download/sport.png");
			ViewButton el35 = new ViewButton();
			el35.setName("影子对话");
			el35.setUrl("http://123.56.200.202/download/sport.png");
			sub_button3.add(el31);
			sub_button3.add(el32);
			sub_button3.add(el33);
			sub_button3.add(el34);
			sub_button3.add(el35);
